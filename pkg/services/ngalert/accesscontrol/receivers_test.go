...
func TestReceiverAccess(t *testing.T) {
	...
	testCases := []struct {
		...
		// Receiver test.
		{
			name: "global receiver test should have test permission",
			user: newViewUser(ac.Permission{Action: ac.ActionAlertingReceiversTest, Scope: models.ScopeReceiversAll}),
			expected: map[string]models.ReceiverPermissionSet{
		...
		},
		{
			...
			user: newViewUser(
				ac.Permission{Action: ac.ActionAlertingReceiversTest, Scope: models.ScopeReceiversProvider.GetResourceScopeUID(recv1.UID)},
				ac.Permission{Action: ac.ActionAlertingReceiversTest, Scope: models.ScopeReceiversProvider.GetResourceScopeUID(recv3.UID)},
			),
			expected: map[string]models.ReceiverPermissionSet{
				recv1.UID: permissions(models.ReceiverPermissionTest),
				recv2.UID: permissions(),
		...
		},
		{
			...
			user: newViewUser(
				ac.Permission{Action: ac.ActionAlertingReceiversTest, Scope: models.ScopeReceiversProvider.GetResourceScopeUID(recv1.UID)},
				ac.Permission{Action: ac.ActionAlertingReceiversUpdate, Scope: models.ScopeReceiversProvider.GetResourceScopeUID(recv1.UID)},
				ac.Permission{Action: ac.ActionAlertingReceiversTest, Scope: models.ScopeReceiversProvider.GetResourceScopeUID(recv2.UID)},
				ac.Permission{Action: ac.ActionAlertingReceiversDelete, Scope: models.ScopeReceiversProvider.GetResourceScopeUID(recv3.UID)},
			),
			expected: map[string]models.ReceiverPermissionSet{
